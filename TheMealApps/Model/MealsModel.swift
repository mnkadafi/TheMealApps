...
struct MealModel: Identifiable, Equatable, Hashable, Codable {
  let id: String?
  let title: String?
...
//struct DetailMealModel: Codable {
//  let id: String?
//  let title: String?
//  let drinkAlternate: String?
//  let category: String?
...
//    ingredients = []
//    for i in 1...20 {
//      if let ingredient = try? container.decode(String.self, forKey: .init(stringValue: "strIngredient\(i)")!),
